...
#' Two factor matrices, namely L and R are generated by hydrar.als.
...
#' 
#' The \code{predict.hydrar.als} function predicts ratings using previously
#' generated factor matrices: L and R.
#' @param data (hydrar.matrix) The input data can be a list of user-ids. In this
...
#' @export
#' @return a \code{hydrar.matrix} which contain a list of triples: {user-id,
